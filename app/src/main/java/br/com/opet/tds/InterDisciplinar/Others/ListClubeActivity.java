...
import br.com.opet.tds.InterDisciplinar.API.Util;
import br.com.opet.tds.InterDisciplinar.CRUD.CadastrarActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent cadastroClube = new Intent(ListClubeActivity.this,CadastrarActivity.class);
